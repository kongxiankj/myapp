 ...
 *           'home-tab': {
 *             prefetchTemplate: false,
 *             templateUrl: "tabs-templates/tab-taskdetail.html",
 ...
 *   .state('index', {
 *     url: '/',
 *     templateUrl: 'tab-taskdetail.html'
 *   })
 *   .state('music', {
 *     url: '/music',
 ...
 * and then try to load tab-taskdetail.html into the `<ion-nav-view>`.
 *
 * Pages are loaded by the URLs given. One simple way to create templates in Angular is to put
 * them directly into your HTML file and use the `<script type="text/ng-template">` syntax.
 * So here is one way to put tab-taskdetail.html into our app:
 *
 * ```html
